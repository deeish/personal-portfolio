...
function Projects() {
  ...
  const youtubeUrl = PROJECTS_CONFIG.MYCABINET.youtubeUrl;
  const videoId = youtubeUrl.split("v=")[1]?.split("&")[0];

  return (
    <div className="projects-container">
      {/* Background decorative elements */}
      <div className="projects-bg-shapes" aria-hidden="true">
      ...
      <header className="projects-header">
        ...
        <div className="projects-title-underline" aria-hidden="true"></div>
      </header>

      {/* Featured Project - MyCabinet */}
      <section className="featured-project" aria-labelledby="projects-heading">
          ...
          <div className="project-content">
            <div className="project-media">
              <div className="video-wrapper">
                <iframe
                  ...
                  title="MyCabinet App Demo Video"
                  style={{ border: 'none' }}
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                  aria-label="MyCabinet mobile application demo video"
                ></iframe>
              </div>
            </div>
            ...
            <div className="project-details">
              ...
              <div className="project-links">
                <a 
                  href={PROJECTS_CONFIG.MYCABINET.githubUrl}
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="project-link"
                  aria-label="View MyCabinet project on GitHub (opens in new tab)"
                >
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                  className="project-link"
                  aria-label="Watch MyCabinet demo video on YouTube (opens in new tab)"
                >
                  <svg className="link-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <div className="screenshots-gallery">
              <figure className="screenshot-item">
                <img 
                  ...
                  alt="Checkm8 chess game interface showing a game in progress" 
              ...
              <figure className="screenshot-item">
                <img 
                  ...
                  alt="Checkm8 chess game showing post-game analysis and statistics" 
                  className="screenshot-image"
                  loading="lazy"
                />
              </figure>
          ...
          <div className="project-details-compact">
            ...
            <div className="project-links">
              <a 
                ...
                rel="noopener noreferrer"
                className="project-link"
                aria-label="View Checkm8 project on GitHub (opens in new tab)"
              >
                <svg className="link-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                </svg>
